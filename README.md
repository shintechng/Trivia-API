...
Sample: curl http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{"question": "what state are you from Nigeria?", "answer": "Lagos", "difficulty": 3, "category": "3" }'
Created question:
{
  "created": 25,
  "question_created": "what state are you from Nigeria?",
  "questions": [
    {
      "answer": "Apollo 13",
      "category": 5,
